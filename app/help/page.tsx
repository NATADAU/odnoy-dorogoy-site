  ...
  return (
    <>
      <section className="page-hero page-hero-help" id="top">
        ...
        <p>{clear ? "Можно стать волонтёром, рассказать о клубе или предложить сотрудничество." : "Можно быть рядом делом, профессиональным опытом, информационной или партнёрской поддержкой."}</p>
      </section>
      <section className="section help-grid">
        <article className="help-card help-card-coral"><span>01</span><h2>{clear ? "Стать волонтёром" : "Помочь временем и опытом"}</h2><p>{clear ? "Напишите нам. Расскажите, что вы умеете и когда можете помогать." : "Расскажите, чем вы хотели бы заниматься, какие у вас навыки и сколько времени вы готовы уделять. Мы обсудим подходящий формат участия."}</p><a className="button button-dark" href="mailto:onewaysc@yandex.ru?subject=Хочу стать волонтёром">Написать о волонтёрстве <b>↗</b></a></article>
        <article className="help-card help-card-mint"><span>02</span><h2>{clear ? "Предложить поддержку" : "Стать партнёром"}</h2><p>{clear ? "Организация может помочь делом, материалами или услугами." : "Если вы представляете компанию или сообщество, можно предложить материалы, профессиональную помощь, площадку или совместный проект."}</p><a className="button button-light" href="mailto:onewaysc@yandex.ru?subject=Предложение о партнёрстве">Предложить партнёрство <b>↗</b></a></article>
        <article className="help-card help-card-dark"><span>03</span><h2>{clear ? "Рассказать о клубе" : "Помочь узнать о проектах"}</h2><p>{clear ? "Поделитесь новостью клуба с друзьями." : "Подписка, репост анонса или рассказ о проектах помогают новым участникам, волонтёрам и партнёрам находить организацию."}</p><a className="button button-white" href="https://vk.com/club_oneway" target="_blank" rel="noreferrer">Перейти во ВКонтакте <b>↗</b></a></article>
      </section>
