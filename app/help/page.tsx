  ...
  return (
    <>
      ...
      <section className="section help-grid">
        ...
        <article className="help-card help-card-dark"><span>03</span><h2>{clear ? "Рассказать о клубе" : "Помочь узнать о проектах"}</h2><p>{clear ? "Поделитесь новостью клуба с друзьями." : "Подписка, репост анонса или рассказ о проектах помогают новым участникам, волонтёрам и партнёрам находить организацию."}</p><a className="button button-white" href="https://vk.ru/onewaykolomna" target="_blank" rel="noreferrer">Перейти во ВКонтакте <b>↗</b></a></article>
      </section>
